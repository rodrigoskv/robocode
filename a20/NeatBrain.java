...
public class NeatBrain {
    ...
    // Lê o arquivo gerado pelo trainer
    public void loadFromFile(File file) throws IOException {
        try (BufferedReader br = new BufferedReader(new FileReader(file))) {
            String line;

            // hidden: HIDDEN_SIZE linhas, cada uma com INPUT_SIZE pesos + 1 bias
            ...
            // output: OUTPUT_SIZE linhas, cada uma com HIDDEN_SIZE pesos + 1 bias
